...
$aModule = [
    ...
    'extend'        => [
        \OxidEsales\Eshop\Application\Model\PaymentGateway::class => OxidSolutionCatalysts\Stripe\Application\Model\PaymentGateway::class,
        \OxidEsales\Eshop\Application\Model\Order::class => OxidSolutionCatalysts\Stripe\Application\Model\Order::class,
        \OxidEsales\Eshop\Application\Model\OrderArticle::class => OxidSolutionCatalysts\Stripe\Application\Model\OrderArticle::class,
        \OxidEsales\Eshop\Application\Model\Payment::class => OxidSolutionCatalysts\Stripe\Application\Model\Payment::class,
        \OxidEsales\Eshop\Application\Controller\Admin\ModuleConfiguration::class => OxidSolutionCatalysts\Stripe\Application\Controller\Admin\ModuleConfiguration::class,
        \OxidEsales\Eshop\Application\Controller\Admin\ModuleMain::class => OxidSolutionCatalysts\Stripe\Application\Controller\Admin\ModuleMain::class,
        \OxidEsales\Eshop\Application\Controller\Admin\PaymentMain::class => OxidSolutionCatalysts\Stripe\Application\Controller\Admin\PaymentMain::class,
        \OxidEsales\Eshop\Application\Controller\Admin\OrderMain::class => OxidSolutionCatalysts\Stripe\Application\Controller\Admin\OrderMain::class,
        \OxidEsales\Eshop\Application\Controller\Admin\OrderOverview::class => OxidSolutionCatalysts\Stripe\Application\Controller\Admin\OrderOverview::class,
        \OxidEsales\Eshop\Application\Controller\PaymentController::class => OxidSolutionCatalysts\Stripe\Application\Controller\PaymentController::class,
        \OxidEsales\Eshop\Application\Controller\OrderController::class => OxidSolutionCatalysts\Stripe\Application\Controller\OrderController::class,
        \OxidEsales\Eshop\Core\Email::class => OxidSolutionCatalysts\Stripe\Core\Email::class,
        \OxidEsales\Eshop\Core\Session::class => OxidSolutionCatalysts\Stripe\Core\Session::class,
    ],
    'controllers'   => [
