...
$aLang = array(
    ...
    'SHOP_MODULE_sStripeRefundMailRecipient'            => 'Bestätigungsmail bei Rückerstattung',
    'SHOP_MODULE_sStripeRefundMailRecipient_0'          => 'Keine Mail versenden',
    'SHOP_MODULE_sStripeRefundMailRecipient_1'          => 'An den Kunden',
    'SHOP_MODULE_sStripeRefundMailRecipient_2'          => 'An den Shop-Betreiber',
    'SHOP_MODULE_sStripeRefundMailRecipient_3'          => 'An Kunden und Shop-Betreiber',
    'HELP_SHOP_MODULE_sStripeRefundMailRecipient'       => 'Wer wird per E-Mail informiert, wenn im Backend über die Stripe-Rückerstattungsmaske eine Rückerstattung ausgelöst wurde und Stripe sie angenommen hat? Die Mail nennt Bestellnummer und erstatteten Betrag.',
    'SHOP_MODULE_sStripeCancelMailRecipient'            => 'Bestätigungsmail bei Storno',
    'SHOP_MODULE_sStripeCancelMailRecipient_0'          => 'Keine Mail versenden',
    'SHOP_MODULE_sStripeCancelMailRecipient_1'          => 'An den Kunden',
    'SHOP_MODULE_sStripeCancelMailRecipient_2'          => 'An den Shop-Betreiber',
    'SHOP_MODULE_sStripeCancelMailRecipient_3'          => 'An Kunden und Shop-Betreiber',
    'HELP_SHOP_MODULE_sStripeCancelMailRecipient'       => 'Wer wird per E-Mail informiert, wenn eine Stripe-Bestellung im Backend über die Bestellliste storniert wurde? Ein Storno löst keine Rückerstattung aus (eine noch nicht eingezogene Zahlung wird bei Stripe lediglich abgebrochen) — diese Mail bestätigt nur die Stornierung. Abbrüche durch den Kunden im Checkout und Storno-Meldungen von Stripe lösen keine Mail aus.',
