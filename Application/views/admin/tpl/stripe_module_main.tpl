        ...
        <tr>
            ...
            <td width="" valign="top">
                ...
                <dl class="moduleDesc clear">
                    ...
                    <dd>[{$oModule->getInfo('version')|default:'-'}] [{if $oView->stripeShowOldVersionWarning()}] <span style="color:red;margin-left: 1rem;"><strong>[{oxmultilang ident="STRIPE_MODULE_VERSION_OUTDATED"}] [{$oView->stripeGetNewestReleaseVersion()}]</strong></span>[{/if}]</dd>
